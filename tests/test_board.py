...
def test_board_host_target(b, mocker):
    ...
    mock_serial = mocker.patch(
        "roast.component.board.target_board.Serial", return_value=mocker.Mock("serial")
    )
    ...
    mock_relay = mocker.patch(
        "roast.component.board.target_board.Relay", return_value=mocker.Mock("relay")
    )
    ...
    mock_xexpect = mocker.patch(
        "roast.component.board.target_board.Xexpect", return_value="xexpect"
    )
...
def test_board_qemu(b, mocker):
    ...
    mock_log = mocker.patch(
        "roast.component.board.target_board.log", return_value=mocker.Mock("log")
    )
...
def test_board_put(b, mocker):
    ...
    mock_scp = mocker.patch("roast.component.board.target_board.scp_file_transfer")
    b.put("a", "b")
